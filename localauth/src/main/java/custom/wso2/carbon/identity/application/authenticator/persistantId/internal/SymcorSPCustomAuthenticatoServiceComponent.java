...
import custom.wso2.carbon.identity.application.authenticator.persistantId.SymcorSPCusotmAuthenticator;
...
public class SymcorSPCustomAuthenticatoServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        try {
            SymcorSPCusotmAuthenticator symcorAuth = new SymcorSPCusotmAuthenticator();
